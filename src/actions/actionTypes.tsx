...
export const SEND_CUSTOMER_AVC_CVC_IDS = "SEND_CUSTOMER_AVC_CVC_IDS";
export const SEND_CUSTOMER_WIFI_STATS = "SEND_CUSTOMER_WIFI_STATS";
export const SEND_DEVICE_INFO = "SEND_DEVICE_INFO";
export const SEND_CUSTOMER_ONLINE_INFO = "SEND_CUSTOMER_ONLINE_INFO";
